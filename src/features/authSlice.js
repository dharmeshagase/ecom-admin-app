...
// console.log(user)
const initialStateValue = user ? { isLoggedIn: true, isLoading: false, user:JSON.parse(user).user,token:JSON.parse(user).token } : { isLoggedIn: false, isLoading: false, user: null,token:null }
